...
(
    ...
    `password_init_yn`                  VARCHAR(1)     DEFAULT 'N'         NOT NULL COMMENT '비밀번호 초기화 필요 여부',
    ...
    `rejoin_yn`                         VARCHAR(1)     DEFAULT 'N'         NOT NULL COMMENT '재가입여부',
...
(
    ...
    `default_yn`        VARCHAR(1)     DEFAULT 'N'                  COMMENT '기본배송지 여부',
    `address_valid_yn`  VARCHAR(1)     DEFAULT                 NULL COMMENT '주소검증 여부',
    `delete_yn`         VARCHAR(1)                             NOT NULL,
    `created_user_id`   BIGINT                                 NOT NULL,
    `created_datetime`  DATETIME       DEFAULT CURRENT_TIMESTAMP NOT NULL,
    `modified_user_id`  BIGINT                                 NULL,
...
(
    ...
    `main_category_yn`           VARCHAR(1) NOT NULL DEFAULT 'N' COMMENT '대표 카테고리 여부',
